...
const OutputForm_3 = ({ processedData, numberOfYears, numberOfYearAccMP, finalNotionalAmount, age, currencyRate, setFinalNotionalAmount, numOfRowInOutputForm_1,cashValueInfo }) => {
  const { t } = useTranslation();
  const [age1, setAge1] = useState(cashValueInfo.age1);
  const [age2, setAge2] = useState(cashValueInfo.age2);
  ...
  const reset = () => {
    if (window.confirm(t('outputForm3.resetConfirmation'))) {
      ...
      setAge1(cashValueInfo.age1);
      setAge2(cashValueInfo.age2);
